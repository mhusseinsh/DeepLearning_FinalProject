...
def plot(dimension):
		...
		plt.suptitle('Model Loss (raw data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		...
		for row in ax:
			for col in row:
				...
				cnt+=1
				col.legend(['train', 'test'], loc='best', fancybox=True, framealpha=0.5)
		plt.suptitle('Model Loss (scaled data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		...
		ax.set_title('True vs Baseline (raw data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		#plt.show()
		...
		for row in ax:
			for col in row:
				...
				cnt+=1
		plt.suptitle('True vs Network (raw data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		...
		for row in ax:
			for col in row:
				...
				cnt+=1
		plt.suptitle('Comparison (raw data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		...
		for row in ax:
			for col in row:
				...
				col.legend(['true', 'baseline', 'network'], loc='best', fancybox=True, framealpha=0.5)
				cnt+=1
		plt.suptitle('Comparison (scaled data) - ' + str(time_steps), fontsize=20, fontweight="bold")
		...
		for row in ax:
			for col in row:
				...
				col.set_xlabel('True Values')
				cnt+=1
		plt.suptitle('True vs Network (scaled data) - ' + str(time_steps), fontsize=20, fontweight="bold")
